...
export const DEFAULT_TEMPLATES: readonly PanelTemplate[] = [
  ...
  { kind: "chart", title: "avg Obj Size", metrics: ["local.oplog.rs.stats.storageStats.avgObjSize"], x: 15, y: 49, w: 9, h: 6 },
  ...
  { kind: "chart", title: "Disk writes", metrics: ["rate(systemMetrics.disks.*.write_sectors)", "div(rate(systemMetrics.disks.*.write_time_ms), rate(systemMetrics.disks.*.writes))"], x: 8, y: 76, w: 8, h: 7 },
  ...
  { kind: "chart", title: "Disk reads", metrics: ["rate(systemMetrics.disks.*.read_sectors)", "div(rate(systemMetrics.disks.*.read_time_ms), rate(systemMetrics.disks.*.reads))"], x: 0, y: 81, w: 8, h: 7 },
