...
/**
 * Node filesystem backend. Used by tests, and the path a server-side ingest would take.
 * Imports are dynamic so bundling for the browser never pulls `node:fs` in.
 */
